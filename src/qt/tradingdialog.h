...
private slots:
    ...
    QString BuyCADS(QString OrderType, double Quantity, double Rate);
    QString SellCADS(QString OrderType, double Quantity, double Rate);
