...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CADS");
    case mBTC: return QString("mCADS");
    case uBTC: return QString::fromUtf8("μCADS");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("Cads");
    case mBTC: return QString("Milli-Cads (1 / 1,000)");
    case uBTC: return QString("Micro-Cads (1 / 1,000,000)");
    default: return QString("???");
    }
}
