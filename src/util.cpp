...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\CryptoAdSolution
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\CryptoAdSolution
    // Mac: ~/Library/Application Support/Cads
    // Unix: ~/.cryptoadsolution
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CryptoAdSolution";
#else
    fs::path pathRet;
    ...
    return pathRet / "CryptoAdSolution";
#else
    // Unix
    return pathRet / ".cryptoadsolution";
#endif
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "cads.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "cadsd.pid"));
