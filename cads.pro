...
isEmpty(BDB_LIB_PATH) {
    ...
    windows:BDB_LIB_PATH=C:/deps/bdb-4.8/lib
}
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    windows:BDB_INCLUDE_PATH=C:/deps/bdb-4.8/include
}
...
isEmpty(OPENSSL_LIB_PATH) {
    ...
    windows:OPENSSL_LIB_PATH=C:/deps/openssl-1.0.1p/lib
}
...
macx:ICON = src/qt/res/icons/cads.icns
macx:TARGET = "Cads-Qt"
